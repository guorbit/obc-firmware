...
package body Tc_Provider is
   procedure request_tc_Transition is
      begin
         case ctxt.state is
            when asn1Sccwait =>
         ...
         while (trId /= -1) loop
            case trId is
               when 0 =>
                  --  k_max := 999 (12,13)
                  ctxt.k_max := 999;
                  --  NEXT_STATE Wait (14,18) at 320, 115
                  trId := -1;
               ...
               when 1 =>
                  ...
                  --  NEXT_STATE Wait (22,22) at 442, 345
                  trId := -1;
                  ctxt.State := asn1SccWait;
                  goto Continuous_Signals;
               when CS_Only =>
