...
ERR_SYSTEM_MODE:constant Integer := 221; -- idle | uplink | downlink | imaging | processing
...
ERR_SUBSYSTEM_ADDRESS:constant Integer := 226; -- obc | comms | electrical | mechanical | control | software | payload
