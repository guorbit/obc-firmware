...
package Tm_Collection_RI is

   procedure Request_Tm (Temp : out asn1SccTemperature_Generic; Depl_D : out asn1SccDeployment_Digital; Depl_A : out asn1SccDeployment_Analogue);

   procedure Check_Queue (Res : out adaasn1rtl.Asn1Boolean)
      with Import, Convention => C, Link_Name => "tm_collection_check_queue";
