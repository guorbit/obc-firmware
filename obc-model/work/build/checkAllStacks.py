...
def report_node_linux():
   ...
   def report_partition_demo():
       ...
       pohic_stack_of = {
           ...
           "state_handler_entrypoint_poll_aoi" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "state_handler_entrypoint_poll_mcp" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "state_handler_entrypoint_toggle_pwr" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "state_handler_entrypoint_trig_aoi" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "state_handler_entrypoint_trig_mcp" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
           
           "state_handler_entrypoint_trig_pwr" : 8388608,  # Linux threads default to "ulimit -s" (8192K by default)
