...
void msp430_eusci_a_serial_minimal_init(void)
{
    ...
    if(pohidrv_node_2_msp430_eusci_a_serial_minimal.exist.use_paritybit)
    {
        if(pohidrv_node_2_msp430_eusci_a_serial_minimal.exist.parity && pohidrv_node_2_msp430_eusci_a_serial_minimal.use_paritybit)
        {
            if(pohidrv_node_2_msp430_eusci_a_serial_minimal.parity == Parity_T_even)
            {
    ...
    if(pohidrv_node_2_msp430_eusci_a_serial_minimal.exist.bits)
    {
        switch(pohidrv_node_2_msp430_eusci_a_serial_minimal.bits)
        {
        case 7:
    ...
    if(pohidrv_node_2_msp430_eusci_a_serial_minimal.exist.speed)
    {
        switch(pohidrv_node_2_msp430_eusci_a_serial_minimal.speed)
        {
