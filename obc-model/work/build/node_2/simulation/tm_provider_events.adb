...
package body Tm_Provider_Events is

   procedure Process_Event
     (Event        : asn1sccObservable_Event;
      Global_State : in out asn1SccSystem_State)
   is
      Evt : constant asn1sccTm_Provider_Event :=
              (case Event.Kind is
                 when Input_Event_Present =>
                    Event.Input_Event.Event.Tm_Provider,
                 when Output_Event_Present =>
                    Event.Output_Event.Event.Tm_Provider,
                 when others => asn1sccTm_Provider_Event_Init);
   ...
   procedure Print_Event (Event : asn1sccTm_Provider_Event) is
   begin
      null;
   end Print_Event;
