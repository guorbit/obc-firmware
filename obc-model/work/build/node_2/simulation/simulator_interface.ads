...
private
   ...
   procedure Loc_Provider_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "loc_provider_check_queue";
   procedure State_Handler_Entrypoint_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "state_handler_entrypoint_check_queue";
   procedure Tc_Provider_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "tc_provider_check_queue";
   procedure Tc_Validation_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "tc_validation_check_queue";
   procedure Tm_Collection_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "tm_collection_check_queue";
   procedure Tm_Provider_Check_Queue (res : out Boolean)
      with Export, Convention => C, Link_Name => "tm_provider_check_queue";
