...
package body Tc_Provider_Events is

   procedure Process_Event
     (Event        : asn1sccObservable_Event;
      Global_State : in out asn1SccSystem_State)
   is
      Evt : constant asn1sccTc_Provider_Event :=
              (case Event.Kind is
                 when Input_Event_Present =>
                    Event.Input_Event.Event.Tc_Provider,
                 when Output_Event_Present =>
                    Event.Output_Event.Event.Tc_Provider,
                 when others => asn1sccTc_Provider_Event_Init);
   ...
   procedure Print_Event (Event : asn1sccTc_Provider_Event) is
   begin
      null;
   end Print_Event;
