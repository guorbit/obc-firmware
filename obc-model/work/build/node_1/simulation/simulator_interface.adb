...
package body Simulator_Interface is
      ...
      case Event.Kind is
         ...
         when Input_Event_PRESENT =>
            case Event.Input_Event.Event.Kind is
               when Gui_PRESENT =>
                  Gui_Events.Process_Event (Event, User_State);
            end case;
   ...
   begin
      ...
      ES.Backup_Ctxt := Full_State;
      ES.Backup_Hash := ES.State_Hash (Full_State);
      Gui_Events.Exhaust_Interfaces (User_State, Callback => ES_Callback'Access);
...
--              when Gui_PRESENT =>
--                 Gui_Events.Print_Event (Event => Event.Input_Event.Event.Gui);
--              @@END_TABLE@@
--           end case;
--        when Output_Event_PRESENT =>
--           case Event.Output_Event.Event.Kind is
--              @@TABLE'ALIGN_ON("=>", "(", "Global")@@
--              when Gui_PRESENT =>
--                 Gui_Events.Print_Event (Event => Event.Output_Event.Event.Gui);
--              @@END_TABLE@@
--           end case;
--     end case;
   end Print_Event;
