...
def Exercise_gs_gui(queue):
   ...
   queue.sendMsg('tc_change_mission_mode', '''{target-mission-mode mission-idle}''')
   ...
   queue.sendMsg('tc_change_mission_mode', '''{ target-mission-mode  mission-imaging }''')
   queue.expectMsg('report_mission_mode_change', '''{ target-mission-mode  mission-imaging, system-mode-status-report  { eps-report  { eps-mode  eps-high-power, eps-last-op  mode-status-nop }, comms-report  { comms-mode  comms-downlink, comms-last-op  mode-status-nop }, deployer-report  { deployer-mode  deployer-idle, deployer-last-op  mode-status-nop }, adcs-report  { adcs-mode  adcs-idle, adcs-last-op  mode-status-nop }, payload-report  { payload-mode  payload-imaging, payload-last-op  mode-status-change }, pipeline-report  { pipeline-mode  pipeline-idle, pipeline-last-op  mode-status-nop } } }''', ignoreOther=False)
# Entry point
